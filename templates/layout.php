...
<body class="font-sans" x-data="{ cartOpen: false }" style="background-color: <?php echo htmlspecialchars($themePageBg); ?>; color: <?php echo htmlspecialchars($themeTextColor); ?>;">
    ...
    <div class="text-white border-b border-gray-800" style="background-color: <?php echo htmlspecialchars($themeHeaderBg); ?>;">
        <div class="container mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <a href="/" class="flex items-center gap-2">
                ...
                <?php else: ?>
                    <span class="text-2xl font-bold tracking-tight text-white"><?php echo htmlspecialchars($storeName); ?></span>
                <?php endif; ?>
            </a>
            ...
            <div class="flex items-center gap-6 text-sm">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center gap-2 hover:text-orange-500 transition-colors">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white text-gray-800 rounded shadow-lg py-1 z-50" x-cloak>
                            ...
                            <?php endif; ?>
                            <a href="/logout" class="block px-4 py-2 hover:bg-gray-100"><?php echo __('Sign out'); ?></a>
                        </div>
                    </div>
                <?php else: ?>
                    <a href="/login" class="flex items-center gap-2 hover:text-orange-500 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                        <span><?php echo __('Sign in'); ?></span>
                    </a>
                <?php endif; ?>

                <a href="/cart" class="relative hover:text-orange-500 transition-colors flex items-center gap-2">
                    <div class="relative">
    ...
    <div class="bg-white border-b shadow-sm sticky top-0 z-40">
        <div class="container mx-auto px-4">
            <nav class="flex items-center space-x-8 py-3 text-sm font-semibold text-gray-600 overflow-x-auto">
                <?php
